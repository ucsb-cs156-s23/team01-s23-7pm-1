...
describe("ClothIndexPage tests", () => {
    ...
    test("renders correct fields", () => {
        ...
        const name = screen.getByText("Patagonia Shirt");
        expect(name).toBeInTheDocument();

        const brand = screen.getByText("Patagonia");
    ...
    test("delete button calls delete and reloads page", async () => {
        ...
        const expectedMessage = `ClothIndexPage deleteCallback: {"id":3,"name":"Patagonia Shirt","type": "shirt", "brand":"Patagonia"}`;
